...
REM Uso: TESTAR.bat [musica_limpa|musica_pura|audio_zelda_queue|legendas|antes_audio|audio_nativo|audio_nativo_clocked|audio_counter|audio_counter_vi|diagnostico_audio], TESTAR.bat voz N, sem_polef, sem_reverb ou ganho_baixo.
...
REM proxima analise. O executavel cria BMP+TXT em lab_test quando F5 e pressionado.
set "WPJ2_CAPTURE_DIR=%~dp0lab_test"
if /I "%WPJ2_PROFILE%"=="antes_audio" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\antes_audio_compat"
if /I "%WPJ2_PROFILE%"=="audio_nativo" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_nativo_rsp"
if /I "%WPJ2_PROFILE%"=="audio_nativo_clocked" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_nativo_clocked"
if /I "%WPJ2_PROFILE%"=="audio_counter" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_counter"
if /I "%WPJ2_PROFILE%"=="audio_counter_vi" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_counter_vi"
if /I "%WPJ2_PROFILE%"=="audio_nativo_seco" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_nativo_seco"
if /I "%WPJ2_PROFILE%"=="voz" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\voz_%~2"
if /I "%WPJ2_PROFILE%"=="sem_polef" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\sem_polef"
if /I "%WPJ2_PROFILE%"=="sem_reverb" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\sem_reverb"
if /I "%WPJ2_PROFILE%"=="estado_audio" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\estado_audio"
if /I "%WPJ2_PROFILE%"=="audio550" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio550"
if /I "%WPJ2_PROFILE%"=="ganho_baixo" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\ganho_baixo"
if /I "%WPJ2_PROFILE%"=="diagnostico_audio" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\diagnostico_audio"
if /I "%WPJ2_PROFILE%"=="musica_pura" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\musica_pura"
if /I "%WPJ2_PROFILE%"=="musica_limpa" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\musica_limpa"
if /I "%WPJ2_PROFILE%"=="audio_zelda_queue" set "WPJ2_CAPTURE_DIR=%~dp0lab_test\audio_zelda_queue"
...
set "WPJ2_AUDIO_BUFFER_DIR=%WPJ2_CAPTURE_DIR%\audio_buffers"
if not exist "%WPJ2_AUDIO_BUFFER_DIR%" mkdir "%WPJ2_AUDIO_BUFFER_DIR%"
...
echo Teste encerrado. Metricas: lab_test\run_metrics.txt; audio: lab_test\audio_capture.wav
exit /b %WPJ2_EXIT%
