...
set INC=/I "%RECOMP_INC%" /I "%PROJ%\src\RecompiledFuncs" /I "%PROJ%\runtime"
set FLAGS=/nologo /c /O1 /std:c17 /MP /wd4101 /wd4102 /wd4189

echo === compilando src\RecompiledFuncs ===
cl %FLAGS% %INC% "%PROJ%\src\RecompiledFuncs\funcs_*.c" /Fo"%PROJ%\build\obj\\"
