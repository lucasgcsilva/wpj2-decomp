...
| `wpj2_probe.exe` | preservado | sonda usada por `TESTAR.bat` e `RODAR.bat` |
...
Em 22/08/2026, `JOGAR.bat` foi removido por duplicar a execução interativa já
centralizada em `TESTAR.bat`. Os cinco `.obj` encontrados na raiz eram saídas
intermediárias ignoradas pelo Git; os builds válidos usam objetos sob `build/`.
